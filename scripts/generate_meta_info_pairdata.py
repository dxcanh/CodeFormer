...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--input',
        nargs='+',
        default=['datasets/super_resolution/train_high_resolution', 'datasets/super_resolution/train_low_resolution'],
    ...
    parser.add_argument(
        '--meta_info',
        type=str,
        default='datasets/super_resolution/meta_info/meta_info_super_resolution_sub_pair.txt',
